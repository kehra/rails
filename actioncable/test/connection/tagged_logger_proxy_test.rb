...
class ActionCable::Server::TaggedLoggerProxyTest < ActionCable::TestCase
  ...
  test "tags are flattened and can be extended uniquely" do
    ...
    proxy = ActionCable::Server::TaggedLoggerProxy.new(logger, tags: [ "Cable", [ "User" ] ])
  ...
  test "tag yields directly for untagged logger" do
    ...
    proxy = ActionCable::Server::TaggedLoggerProxy.new(logger, tags: [ "Cable" ])
